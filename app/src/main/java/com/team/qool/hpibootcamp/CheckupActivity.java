...
public class CheckupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path = "android.resource://" + getPackageName() + "/" + R.raw.checkup_2;
        mContentView.setVideoURI(Uri.parse(path));
        //mContentView.setVideoPath("file:///android_asset/checkup_2.mov");
        ...
        mContentView.setOnTouchListener(new View.OnTouchListener()
        {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                Toast.makeText(CheckupActivity.this,"You just earned 5 credits for this assessment.", Toast.LENGTH_LONG).show();
                finish();
                return false;
            }
        });
